...
const CommunityCouncilSection = () => {
  return (
    <section id="community-council" className="py-12 md:py-16 bg-campaign-light">
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-base md:text-lg text-foreground/75 font-body mb-7 leading-relaxed max-w-xl mx-auto">
