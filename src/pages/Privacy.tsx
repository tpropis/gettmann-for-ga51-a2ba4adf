    ...
    <main className="bg-background py-16 md:py-20">
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <div className="space-y-5 text-muted-foreground leading-relaxed text-base">
          <p>
            Keith for GA LLC ("we", "us", "our") respects your privacy. This
            policy explains how we collect, use, and protect information you
            provide through our website and SMS program.
          </p>
          ...
          <p>
            We collect information you voluntarily submit through our forms,
            including name, email address, ZIP code, and (if provided) phone
            number. We may also collect basic analytics about how visitors use
            the site.
          </p>
          ...
          <p>
            Information is used to communicate with supporters, coordinate
            volunteer activity, process donations, and share campaign updates.
